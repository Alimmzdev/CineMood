package dev.alimmz.cinemood.core.domain.common
...
/**
 * Converts a standard Kotlin [Result] to a [dev.alimmz.cinemood.core.domain.common.BaseResult] while applying a transformation
 ...
 * @return [dev.alimmz.cinemood.core.domain.common.BaseResult.Success] containing the transformed value if the [Result] is successful,
 *         or [dev.alimmz.cinemood.core.domain.common.BaseResult.Error] containing the exception if the [Result] is a failure.
 *
 * Example:
 * ```
