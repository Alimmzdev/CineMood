...
interface MoviesRemoteDataSource {
     ...
     * @return [Result] containing [MoviesResponseDto] or exception
     */
    suspend fun fetchMovies(page: Int): Result<MoviesResponseDto>
     ...
     * @return [Result] containing [MoviesResponseDto] with search results or exception
     *
     * Example:
     * ```
