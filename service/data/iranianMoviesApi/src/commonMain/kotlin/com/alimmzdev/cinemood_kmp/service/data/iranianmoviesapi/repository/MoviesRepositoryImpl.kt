package com.alimmzdev.cinemood_kmp.service.data.iranianmoviesapi.repository

import com.alimmzdev.cinemood_kmp.core.domain.common.BaseResult
import com.alimmzdev.cinemood_kmp.core.domain.common.toBaseResult
...
/**
 * Implementation of [MoviesRepository] that fetches movie data from a remote API.
 *
 * This repository acts as a bridge between the data layer and domain layer by:
 * - Fetching raw data from [MoviesRemoteDataSource] which returns standard Kotlin [Result]
...
class MoviesRepositoryImpl(
     ...
     *
     * This function:
     * 1. Calls [MoviesRemoteDataSource.fetchMovies] to get a [Result] containing [MoviesResponseDto]
     * 2. Converts the [Result] to [BaseResult] using [toBaseResult] extension
     * 3. Transforms the DTO to domain model [MoviesPage] via [toDomainModel] extension
     ...
     * @return [Flow] emitting [BaseResult] with [MoviesPage] on success or [BaseResult.Error] on failure.
     ...
     * @see MoviesRemoteDataSource.fetchMovies
     * @see BaseResult
     * @see MoviesPage
     */
