package dev.alimmz.cinemood.service.domain.repository

import dev.alimmz.cinemood.core.domain.common.BaseResult
import dev.alimmz.cinemood.core.domain.repository.BaseRepository
...
interface MoviesRepository : BaseRepository {
     ...
     */
    fun getMovies(page: Int): Flow<BaseResult<dev.alimmz.cinemood.service.domain.model.MoviesPage>>
     ...
     * ```
     */
    fun searchMovies(query: String, page: Int = 1): Flow<BaseResult<dev.alimmz.cinemood.service.domain.model.MoviesPage>>
}